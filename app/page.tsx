const experience = [
  {
    ...
    bullets: [
      ...
      "Designed and enforced patient lifecycle workflows (REGISTERED → ADMITTED → DISCHARGED) with strict domain rules",
      "Implemented atomic bed assignment and discharge logic to ensure data consistency",
      "Developed and tested REST APIs for patients, beds, medicines, prescriptions, and inventory",
      "Contributed to frontend development by implementing UI screens and integrating APIs for core HMS modules",
      "Debugged and resolved database integrity issues (foreign keys, enums, sequence resets)",
      "Performed end-to-end API testing and shipped production-ready code to GitHub",
    ],
  },
];
